...
public class SysDictServiceImpl extends ServiceImpl<SysDictMapper, SysDict> implements ISysDictService {
	...
	@Override
	public List<DictModel> queryTableDictItems2(String table, String text, String code, String keyword) {
		return baseMapper.queryTableDictItems2(table, text, code, "%"+keyword+"%");
	}
	@Override
