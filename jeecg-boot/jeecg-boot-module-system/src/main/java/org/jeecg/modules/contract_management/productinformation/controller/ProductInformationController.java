package org.jeecg.modules.contract_management.productinformation.controller;
...
@Api(tags="产品信息")
@RestController
@RequestMapping("/productinformation/productInformation")
@Slf4j
public class ProductInformationController extends JeecgController<ProductInformation, IProductInformationService> {
	@Autowired
	...
	public Result<?> queryPageList(ProductInformation productInformation,
								   @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
								   @RequestParam(name="pageSize", defaultValue="10") Integer pageSize,
								   HttpServletRequest req) {
		QueryWrapper<ProductInformation> queryWrapper = QueryGenerator.initQueryWrapper(productInformation, req.getParameterMap());
		Page<ProductInformation> page = new Page<ProductInformation>(pageNo, pageSize);
		IPage<ProductInformation> pageList = productInformationService.page(page, queryWrapper);
	...
	public Result<?> edit(@RequestBody ProductInformation productInformation) {
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, ProductInformation productInformation) {
        return super.exportXls(request, productInformation, ProductInformation.class, "产品信息");
    }
    ...
    */
    ...
    public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
        return super.importExcel(request, response, ProductInformation.class);
    }
