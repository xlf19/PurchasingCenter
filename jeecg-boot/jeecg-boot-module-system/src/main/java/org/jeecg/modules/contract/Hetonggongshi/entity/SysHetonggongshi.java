package org.jeecg.modules.contract.Hetonggongshi.entity;
 ...
 */
@Data
@TableName("sys_hetonggongshi")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="sys_hetonggongshi对象", description="合同公式表")
public class SysHetonggongshi implements Serializable {
	...
	/**扣款类型*/
	@Excel(name = "扣款类型", width = 15, dicCode = "deductiontype")
	@Dict(dicCode = "deductiontype")
