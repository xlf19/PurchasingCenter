...
//		 originalChargeService.removeById(id);
     ...
     * @return
     */
    @AutoLog(value = "原炉料供应商-查询供应商")
    @ApiOperation(value = "原炉料供应商-查询供应商", notes = "原炉料供应商-查询供应商")
    @GetMapping(value = "/searchname")
    public Result<?> searchname(@RequestParam(name = "companyName") String companyName) {
        List<OriginalCharge> list = originalChargeService.searchname(companyName);
        return Result.ok(list);
    }
