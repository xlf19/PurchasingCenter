<template>
  <a-card :bordered="false">
    ...
    <sheng-tie-modal ref="modalForm" @ok="modalFormOk"></sheng-tie-modal>
  </a-card>
</template>
...
import ShengTieModal from './modules/ShengTieModal'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/shengtiedate/qualityDateShengtie/listst',
    ...
    searchList() {
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          let shdw = values.receivingUnit
          this.$refs.modalForm.add(contractNo, shdw)
