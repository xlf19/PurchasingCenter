  ...
  <a-card :bordered="false">
    ...
    <div>
      ...
      <div class="table-operator">
        ...
        <a-button @click="htAddjsd" type="primary" icon="plus">手工添加结算单</a-button>
      </div>
      <!-- table区域-begin -->
      <div>
...
import ContractList from '../ranliao/ContractInformationList'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/zhijianxingxi/zhijianxingxi/listzjrl',
