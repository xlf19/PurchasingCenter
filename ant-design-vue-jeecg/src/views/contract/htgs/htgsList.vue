...
export default {
  components: { JEditableTableByCj, JSearchSelectTagSec, SysHetonggongshiModal },
  ...
  data() {
    return {
      ...
      dataSourceSec: [],
      url: {
        list: '/SysTemplate/sysTemplate/list',
        delete: '/SysTemplate/sysTemplate/delete',
        deleteBatch: '/SysTemplate/sysTemplate/deleteBatch',
        exportXlsUrl: '/SysTemplate/sysTemplate/exportXls',
        importExcelUrl: 'SysTemplate/sysTemplate/importExcel',
        savaHtGongShi: '/SysTemplate/sysTemplate/savaHtGongShi',
