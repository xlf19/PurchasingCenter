  ...
  <a-card :bordered="false">
    ...
    <div>
      ...
      <div class="table-operator">
        <a-button @click="htAdd" type="primary" icon="plus">导入质检结果</a-button>
      </div>
      <!-- table区域-begin -->
      <div>
...
import ContractList from '../feigang/ContractInformationList'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/zhijianxingxi/zhijianxingxi/listzjfg',
    ...
    htAdd() {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          postAction(this.url.htadd, { htxx: htxx, pzh: pzh }).then((res) => {
            if (res.success) {
