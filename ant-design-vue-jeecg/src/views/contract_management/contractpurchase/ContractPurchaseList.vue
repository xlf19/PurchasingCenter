<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('采购合同表')">导出</a-button>
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'签订地点',
            align:"center",
            dataIndex: 'placeSigning'
          },
          {
            title:'交货地点',
            align:"center",
            dataIndex: 'tradingLocations'
          },
          {
            title:'签订时间',
            align:"center",
        ...
        url: {
          list: "/contractpurchase/contractPurchase/list",
