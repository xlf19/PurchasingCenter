        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="物资名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['materialName',{rules: [{required: true, message: '请输入物资名称'}]}]" placeholder="请输入物资名称"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="规格型号" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['specification',{rules: [{required: true, message: '请输入规格型号'}]}]" placeholder="请输入规格型号"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'materialCode','materialName','specification','unit','status','remake'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
